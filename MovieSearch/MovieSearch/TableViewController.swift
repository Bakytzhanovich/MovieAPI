...
class TableViewController: UITableViewController , UISearchBarDelegate{
    ...
    func searchMovie(term: String) {
        ...
        AF.request("https://api.jikan.moe/v4/anime?q=naruto", method: .get, parameters: parameters).responseData { response in
            ...
            if response.response?.statusCode == 200 {
                ...
                if let array = json["data"].array {
                    for item in array {
                        let movie = AnimeNaruto(json: item)
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        searchMovie(term: searchBar.text!)
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.movie = arrayMovie[indexPath.row]
